...
var burn_bonus_dmg: int                = 0     # Thermal Vision: Burn tick hasarına eklenen sabit (Lv1:+1 Lv2:+2 Lv3:+2)
var burn_fast_ticks: bool              = false # Thermal Vision Lv3: Burn 1.5sn aralıkla vurur (4 tick)
...
var overheat_threshold: int           = 30     # Lv1:30 Lv2:25 Lv3:15
